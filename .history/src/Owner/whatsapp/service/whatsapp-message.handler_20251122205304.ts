  ...
  async handleIncomingMessage(
    ...
    if (cleanText === '0') {
      ...
      if (myOrdersSubMenus.has(state)) {
            console.log('dddddddddddddddddddddddddddddddddddddddddddddddddd11111' + state);
      ...
      if (placeOrderStates.has(state)) {
            console.log('dddddddddddddddddddddddddddddddddddddddddddddddddd2222' + state);
        const prevState = userState?.previous_state || 'main_menu';
        await this.restorePreviousState(client, businessId, phone, name, business, prevState);
        return;
      }
          console.log('dddddddddddddddddddddddddddddddddddddddddddddddddd3333' + state);
    }
